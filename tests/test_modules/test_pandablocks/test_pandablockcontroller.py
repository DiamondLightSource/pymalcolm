...
class PandABoxBlockMakerTest(unittest.TestCase):
    ...
    def test_block_fields_adder(self):
        ...
        assert inpa.meta.tags == [
            "group:inputs", "sinkPort:int32:ZERO", "widget:combo",
            "config:1"]
    ...
    def test_block_fields_pulse(self):
        ...
        o = PandABlockController(
            self.client, "MRI", "PULSE2", block_data, "/docs")
        self.process.add_controller(o)
    ...
    def test_block_fields_lut(self):
        ...
        o = PandABlockController(
            self.client, "MRI", "LUT3", block_data, "/docs")
        self.process.add_controller(o)
        ...
        assert func.meta.tags == [
            "group:parameters", "widget:textinput", "config:1"]
