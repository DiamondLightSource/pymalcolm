...
defaultIcon = ""
with open(os.path.split(__file__)[0] +
          "/../../../malcolm/modules/system/icons/epics-logo.svg") as f:
    defaultIcon = f.read()

vxIcon = ""
with open(os.path.split(__file__)[0] +
          "/../../../malcolm/modules/system/icons/vx_epics.svg") as f:
    vxIcon = f.read()

linuxIcon = ""
with open(os.path.split(__file__)[0] +
          "/../../../malcolm/modules/system/icons/linux_epics.svg") as f:
    linuxIcon = f.read()

winIcon = ""
with open(os.path.split(__file__)[0] +
          "/../../../malcolm/modules/system/icons/win_epics.svg") as f:
    winIcon = f.read()
...
class TestIocIconPart(unittest.TestCase):
    ...
    def add_part_and_start(self):
        self.icon = IocIconPart("ICON", os.path.split(__file__)[0] +
