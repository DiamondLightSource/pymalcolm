...
def cs_port_with_motors_in(context: Context,
...
def get_motion_axes(generator: CompoundGenerator, axes_to_move: Sequence[str]) -> List[str]:
...
def cs_axis_mapping(context: Context,
                    layout_table: builtin.util.LayoutTable,
...
def point_velocities(axis_mapping: Dict[str, MotorInfo], point: Point, entry: bool = True) -> Dict[str, float]:
...
def get_motion_trigger(part_info: scanning.hooks.APartInfo) -> scanning.infos.MotionTrigger:
