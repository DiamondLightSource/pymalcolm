...
from malcolm.core import APartName, PartRegistrar, CAMEL_RE, BadValueError, \
    Block
...
class PandAPulseTriggerPart(builtin.parts.ChildPart):
    ...
    def on_configure(self,
        ...
        assert not expected_exports, \
            "PandA %r did not define exports %s" % (
                panda_mri, sorted(expected_exports))
